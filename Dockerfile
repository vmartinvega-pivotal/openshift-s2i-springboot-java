...
MAINTAINER Vicente Martin Vega vicente.martin.vega@gmail.com
# HOME in base image is /opt/app-root/src

# Builder version
ENV BUILDER_VERSION 1.0

LABEL io.k8s.description="Platform for building sdp applications from nexus" \
      io.k8s.display-name="SDP builder 1.0" \
      io.openshift.expose-services="8080:http" \
      io.openshift.tags="Java,sdp,builder"
